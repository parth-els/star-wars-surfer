...
import StarWarsLogo from '../assets/starWarsNew.svg';
...
export default function HeaderComp() {
  ...
  //<svg xmlns="http://www.w3.org/2000/svg" width="2500" height="2500" viewBox="0 0 192.756 192.756"><g fill-rule="evenodd" clip-rule="evenodd">
